...
import { MembershipTier, BillingCycle, getTierPrice } from '../lib/tierPricingConfig';
...
export default function MembershipPaymentModalV2({
  ...
  const monthlyPrice = getTierPrice(targetTier, 'monthly');
  const annualPrice = getTierPrice(targetTier, 'annual');
        ...
        <div className="flex-shrink-0 border-b border-white/10 px-6 py-4 sm:px-8 sm:py-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              >
                {membershipType === 'member' ? 'Member Subscription' : 'Creator Membership'} - {currentStepConfig.title}
              </h2>
          ...
          {step === 'billing' && (
            <div className="space-y-6">
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10 space-y-3">
                ...
                <div className="flex justify-between text-sm">
                  <span className="text-gray-400">Upgrade from {currentTier}</span>
                  <span className="text-rose-400 font-semibold capitalize">{targetTier}</span>
                </div>
                ...
                <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold text-white capitalize">{currentTier}</span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold text-rose-400 capitalize">{targetTier}</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {step === 'success' && (
            <div className="flex items-center justify-center py-8">
              <div className="text-center space-y-6 max-w-sm">
                ...
                <div>
                  <p className="font-bold text-white text-xl">Upgrade Successful!</p>
                  <p className="text-sm text-gray-300 mt-2">
                    Welcome to {targetTier}. Your account has been upgraded.
                  </p>
                </div>
                ...
                <div className="bg-white/5 rounded-lg p-4 border border-white/10 text-left space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-white font-semibold capitalize">{targetTier}</span>
                  </div>
                  <div className="flex justify-between text-sm">
